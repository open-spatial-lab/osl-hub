...
<div class="grid grid-cols-1 bg-slate-50 dark:bg-slate-800 md:grid-cols-3 md:text-center">
						...
						<li>
							...
							{:else if Entry.image}
								<a href={Entry.link} class="py-2">
									<img src={Entry.image} alt={Entry.text} class="footer-image d-block mx-auto d-md-inline" />
								</a>
							{:else}
